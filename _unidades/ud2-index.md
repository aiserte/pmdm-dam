...
1. [Repaso de POO: de Java a Kotlin]({{ '/unidades/ud2-bloque1-repaso-poo/' | relative_url }}) — 2h
...
4. [Introducción ligera a coroutines]({{ '/unidades/ud2-bloque4-coroutines-intro/' | relative_url }}) — 2h
5. [Instalación y primer proyecto en Android Studio]({{ '/unidades/ud2-bloque5-android-studio/' | relative_url }}) — 2h
...
Al terminar esta unidad deberías sentirte cómodo leyendo y escribiendo Kotlin básico, y tener Android Studio funcionando con tu primer proyecto Compose ejecutado al menos una vez.
</div>
